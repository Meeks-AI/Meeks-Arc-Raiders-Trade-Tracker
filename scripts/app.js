...
const P = {
  ...
  quickTrades: [
    '⚡ Quick trades only — be ready to go.',
    '⏱️ No long negotiations — know what you want.',
    '🏃 Fast deals preferred, in-raid on demand.',
    '⚡ Speed is the deal — slow buyers miss out.',
    '🎯 Quick and clean trades only.',
    '⏱️ No timewasters — ready to drop immediately.',
  ],
  acceptOffers: [
...
function generateListing() {
  ...
  const lootedOnly = document.getElementById('opt-lootedOnly')?.checked;
  ...
  if (lootedOnly) parts.push(rnd(P.lootedNote));
